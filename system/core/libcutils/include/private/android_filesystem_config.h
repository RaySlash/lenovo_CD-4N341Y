...
#define AID_WAYLAND         1029
#define AID_GDISP           1030
...
static const struct android_id_info android_ids[] = {
    ...
    { "wayland",   AID_WAYLAND,     "/data/wayland" },
    { "gdisp",     AID_GDISP,       "/data/gdisp" },
    { "package_info",   AID_PACKAGE_INFO,     "/data/packages.list" },
    { "logd",      AID_LOGD,        "/data/logd" },
    { "shell",     AID_SHELL,       "/data/shell" },
    { "inet",      AID_INET,        "/data/inet" },
    { "readproc",  AID_READPROC,    "/proc" },
    { "net_bt_stack",AID_NET_BT_STACK,"/data/bluetooth" },

    { "app",      AID_APP,          "/data/app" },
    { "app_start",AID_APP_START,    "/data/app" },
    { "app_end",  AID_APP_END,          "/data/app" },
};
...
static struct fs_path_config android_files[] = {
    ...
    { 00700, AID_GDISP,     AID_GDISP,    0, "system/chrome/gdisp-broker" },
    { 00700, AID_GDISP,     AID_GDISP,    0, "system/chrome/gdisp-diag" },
    { 00700, AID_GDISP,     AID_GDISP,    0, "system/chrome/gdisp-perf" },
    ...
    { 00550, AID_LOGD,      AID_LOGD,     CAP_MASK_LONG(CAP_SYSLOG) | CAP_MASK_LONG(CAP_AUDIT_CONTROL) | CAP_MASK_LONG(CAP_SETGID) | CAP_MASK_LONG(CAP_SETUID),
      "system/bin/logd" },

...
/**
 * equivalent to `__android_log_vprint`, but taking a bufID.
 */
...
typedef enum log_id {
  ...
  LOG_ID_SECURITY = 6,
  LOG_ID_STATE = 7,
  LOG_ID_KERNEL = 8, /* place last, third-parties can not use it */
...
/*
 * Clear the specific log buffer.
 */
int __android_log_clear(int bufID);

/* Copy of android_alarm.h that has been modified for glibc compatibility */
...
/* the kernel's time.h contains definitions that conflict with glibc's
   sys/types.h and its subincludes */

...
/** Callback for audio delay change of connected Bluetooth speaker.
 *  Used only for the A2DP Source interface.
 *  delay: audio delay in 1/10 ms.
 */
typedef void (*btav_audio_source_delay_callback)(uint16_t delay);
...
typedef struct {
    ...
    btav_audio_source_delay_callback audio_delay_cb;

...
CMetricsLibrary CMetricsLibraryNew(const char* uma_events_file);
...
int CMetricsLibrarySendToUMA(CMetricsLibrary handle, const char* name,
                             int sample, int min, int max, int nbuckets);

// C wrapper for MetricsLibrary::SendEnumToUMA.
int CMetricsLibrarySendEnumToUMA(CMetricsLibrary handle, const char* name,
                                 int sample, int max);
...
// C wrapper for MetricsLibrary::SendRepeatedToUMA.
int CMetricsLibrarySendRepeatedToUMA(CMetricsLibrary handle,
                                     const char* name,
                                     int sample,
                                     int min,
                                     int max,

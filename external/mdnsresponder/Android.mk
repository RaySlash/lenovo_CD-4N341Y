...
LOCAL_CFLAGS := -O2 -g -W -Wall -D__ANDROID__ -D_GNU_SOURCE -DHAVE_IPV6 -DNOT_HAVE_SA_LEN -DUSES_NETLINK -DTARGET_OS_LINUX -fno-strict-aliasing -DHAVE_LINUX -DMDNS_DEBUGMSGS=0 -DMDNS_UDS_SERVERPATH=\"/dev/socket/mdnsd\" -DMDNS_USERNAME=\"mdns\" -DPLATFORM_NO_RLIMIT
LOCAL_SHARED_LIBRARIES := libcutils liblog
ifeq ($(BUILD_EUREKA),)
LOCAL_SYSTEM_SHARED_LIBRARIES := libc
else
LOCAL_CFLAGS += -UHAVE_IPV6 -DBUILD_EUREKA
endif
...
LOCAL_TOOLCHAIN_PREBUILTS := \
    $(LOCAL_PATH)/mDNSShared/dns_sd.h:usr/include/dns_sd.h
endif
LOCAL_SHARED_LIBRARIES := libcutils liblog
